...
class DragBox extends React.Component {
	onMouseDown(e) {
		...
		if (context.props.onDragStart) {
			context.props.onDragStart();
		}
		...
		window.onmouseup = function() {
			...
			if (context.props.onDragEnd) {
				context.props.onDragEnd();
			}
		};
	...
	render() {
		let { left = 0, top = 0, width = 200, height = 100 } = this.props.propertys;
		...
		return (
			...
			>
				<div
					className="vui-drag-n"
					onMouseDown={(e) => {
						return this.onMouseResize('n', e);
					}}
				>
					<div className="vui-drag-point" />
				</div>
				<div
					className="vui-drag-s"
					onMouseDown={(e) => {
						return this.onMouseResize('s', e);
					}}
				>
					<div className="vui-drag-point" />
				</div>
